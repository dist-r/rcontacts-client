...
import { FaUserPlus, FaUser, FaIdBadge, FaEnvelope, FaLock, FaShieldAlt } from 'react-icons/fa';
...
export default function SignUp (){
  ...
  return (
    <section className="min-h-screen flex justify-center items-center bg-linear-to-br from-slate-955 via-slate-900 to-indigo-950 font-sans p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-2xl shadow-[0_0_50px_rgba(97,218,251,0.1)] p-8 md:p-10">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-slate-500 font-mono">rcontacts://client/auth/register</p>
            </div>
          </div>

          {/* Username */}
          <div className="space-y-2">
            <label htmlFor="username" className="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Username</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-600">
                <FaIdBadge className="w-3.5 h-3.5" />
              </span>
              <input
                type="text"
                id="username"
          ...
          {/* Name */}
          <div className="space-y-2">
            <label htmlFor="name" className="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Full Name</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-600">
          ...
          {/* Email */}
          <div className="space-y-2">
            <label htmlFor="email" className="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Email Address</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-600">
          ...
          {/* Confirm Password */}
          <div className="space-y-2">
            <label htmlFor="confirmPassword" className="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Confirm Password</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-600">
          ...
          {isRegistering && (
            <div className="text-center text-[10px] font-mono text-[#61dafb] animate-pulse">
              [status]: creating new user record...
            </div>
          )}
          {registerError && (
          ...
          <div className="pt-1 text-center text-xs text-slate-500">
            ...
            <Link to="/signin" className="text-[#61dafb] hover:underline font-semibold">
              Sign In
            </Link>
          </div>
